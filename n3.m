%Задание 3. Разработайте программу (m-сценарий), позволяющую пользователю задавать с
% помощью мыши два отрезка A и B, после чего выполните твининг отрезка A в отрезок B и
% обратно – отрезка B в отрезок A с отображением исходного отрезка A, целевого отрезка B и
% текущего промежуточного изображения (твина) между A и B.
